...
<body>
	...
	<form:form action="search" modelAttribute="search" method="POST" >
		...
		<table>
			...
			<tr>
				<td>start Date: </td>
				<td><form:input type="date" path="planStartDate"	class="datepicker" date-date-format="mm/dd/yyyy" /></td>
				<td><form:input type="date" path="planEndDate" class="datepicker" date-date-format="mm/dd/yyyy"/></td>
			</tr>
			<tr>
				<td><a href="/" class="btn btn-secondary">Reset</a> <input type="submit" value="search" class="btn btn-primary" /></td>
			</tr>			
		</table>
	</form:form>
